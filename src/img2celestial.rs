...
impl<P: CanonicalProjection, W: ImgXY2ProjXY> Img2Celestial<P, W> {
    ...
    /// Convert lon/lat to image coordinates.
    #[must_use]
    pub fn lonlat2img(&self, lonlat: &LonLat) -> Option<ImgXY> {
        self.proj
            .proj_lonlat(lonlat)
            .and_then(|xy| self.proj2img.proj2img(&xy))
    }

    /// Convert XYZ to image coordinates.
    #[must_use]
